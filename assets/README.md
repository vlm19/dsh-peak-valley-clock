# Peak/valley reminder assets

Bundled media files. The plugin serves them from this directory at runtime
under `/plugins/dsh-peak-valley-clock/assets/*`.

The `.mp4` files are kept in version control via Git LFS so the plugin boots
out of the box:
